Crear una Base de datos en MySql llamada: TP47. Crear una tabla llamada Autores que contenga los campos de la tabla. Realizar CRUD para que la tabla tenga los siguientes datos: Nombre Apellido
